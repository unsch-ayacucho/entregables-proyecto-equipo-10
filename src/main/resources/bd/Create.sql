...
/*  Created On : 28-Jun.-2019 04:23:09 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
(
	...
	CONSTRAINT `PK_Archivo` PRIMARY KEY (`idarchivo` ASC)
)
...
(
	`idcomision` BIGINT NOT NULL AUTO_INCREMENT,
...
(
	`idcomisionmiembro` BIGINT NOT NULL AUTO_INCREMENT,
...
(
	`idconsejofacultad` BIGINT NOT NULL AUTO_INCREMENT,
	`nombre` VARCHAR(50) NOT NULL,
	`fecha_creacion` DATETIME NOT NULL,
...
(
	`idconsejouniversitario` BIGINT NOT NULL AUTO_INCREMENT,
	`nombre` VARCHAR(50) NOT NULL,
	`fecha_creacion` DATETIME NOT NULL,
...
(
	`idinformecf` BIGINT NOT NULL AUTO_INCREMENT,
...
(
	`idinformecu` BIGINT NOT NULL AUTO_INCREMENT,
	`idinforme` BIGINT NOT NULL,
	`aprobado` BOOL NOT NULL,
...
(
	`idinformedetalle` BIGINT NOT NULL AUTO_INCREMENT,
	`idinforme` BIGINT NOT NULL,
...
(
	`idjefedepartamento` BIGINT NOT NULL AUTO_INCREMENT,
	`idusuario` BIGINT NOT NULL,
	`nombres` VARCHAR(50) NOT NULL,
	`apepaterno` VARCHAR(50) NOT NULL,
	`apematerno` VARCHAR(50) NOT NULL,
...
(
	`idresolucion` BIGINT NOT NULL AUTO_INCREMENT,
...
(
	`idtablaev` BIGINT NOT NULL AUTO_INCREMENT,
...
(
	`idtablaevdetalle` BIGINT NOT NULL AUTO_INCREMENT,
	`idtablaev` BIGINT NOT NULL,
...
ALTER TABLE `Promocion` 
 ADD INDEX `IXFK_Promocion_Categoria` (`idcategoria` ASC)
;
...
ALTER TABLE `Promocion` 
 ADD INDEX `IXFK_Promocion_Expediente` (`idexpediente` ASC)
;
...
ALTER TABLE `Docente` 
 ADD CONSTRAINT `FK_Docente_Categoria`
...
ALTER TABLE `JefeDepartamento` 
 ADD CONSTRAINT `FK_JefeDepartamento_Usuario`
	FOREIGN KEY (`idusuario`) REFERENCES `Usuario` (`idusuario`) ON DELETE Restrict ON UPDATE Restrict
;
...
ALTER TABLE `Promocion` 
 ADD CONSTRAINT `FK_Promocion_Expediente`
	FOREIGN KEY (`idexpediente`) REFERENCES `Expediente` (`idexpediente`) ON DELETE Restrict ON UPDATE Restrict
;
